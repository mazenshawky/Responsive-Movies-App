...
class _$_SignUpObject implements _SignUpObject {
  _$_SignUpObject(this.username, this.password);
  ...
  @override
  String toString() {
    return 'SignUpObject(username: $username, password: $password)';
  }
...
abstract class _SignUpObject implements SignUpObject {
  factory _SignUpObject(final String username, final String password) =
      _$_SignUpObject;
